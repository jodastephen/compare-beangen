...
public class IntelliJMutablePerson {
  // NOTES
  ...
  public IntelliJMutablePerson(String name, LocalDate birthDate) {
    this.name = name;
  ...
  public boolean equals(Object o) {
    ...
    IntelliJMutablePerson that = (IntelliJMutablePerson) o;
  ...
  public String toString() {
    return "IntelliJMutablePerson [" + "name='" + name + "'" + ", birthDate='" + birthDate + "'" + "]";
  }
}
