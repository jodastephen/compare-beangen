...
public interface ImmOrgPrivatePerson {
  // NOTES
  // Requires setting up annotation processing
  // Have to write Javadoc on getter
  // Implementation class now private, builder class is public
...
//   * @return the person
//   */
//  public static ImmOrgPrivatePerson of(String name, LocalDate birthDate) {
...
//   * @return the person
//   */
//  public static ImmOrgPrivatePerson.Builder builder() {
...
//     * @return the person
//     */
//    public abstract ImmOrgPrivatePerson build();
//    
//  }
