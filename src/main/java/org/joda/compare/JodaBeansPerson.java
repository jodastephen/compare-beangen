...
public final class JodaBeansPerson implements ImmutableBean {
  ...
  // can create getter methods that return Optional
  ...
  static {
    MetaBean.register(JodaBeansPerson.Meta.INSTANCE);
  }
   ...
   * @return the instance
   */
  public static JodaBeansPerson of(
      String name,
      LocalDate birthDate) {
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -1210031859:  // birthDate
          return ((JodaBeansPerson) bean).birthDate;
      }
